...
javac --module-path "lib/javafx/lib" --add-modules javafx.controls,javafx.fxml -d bin src\client\*.java src\utils\*.java src\gui\*.java

# Run the client
java --module-path "lib/javafx/lib" --add-modules javafx.controls,javafx.fxml -cp bin client.ChatClient
```